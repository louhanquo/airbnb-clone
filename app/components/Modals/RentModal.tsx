...
const RentModal = ()=>{
    ...
    if(step === STEPS.IMAGES){
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Add a photo of your property" subtitle="Show guests your property"/>
                <ImageUpload
                    value={imageSrc}
    ...
    if(step === STEPS.DESCRIPTION){
        bodyContent=(
            <div className="flex flex-col gap-8">
                <Heading title="How would you describe your property" subtitle="Short and informative works best"/>
                <Input 
                    id="title"
                    label="Title"
                    disabled={isLoading}
